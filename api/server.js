 ...
 *   - Fireworks: the correct current serverless slug is
 *               accounts/fireworks/models/llama-v3p1-8b-instruct
 *               (Fireworks' naming scheme replaces dots with
 *               "p", e.g. "v3p1" = v3.1 — confirmed against
 *               Fireworks' own model page/docs. "llama-3.1-8b-
 *               instruct" without that scheme does NOT resolve).
 ...
 *   - Cohere:   command-r-08-2024 is the CURRENT, OFFICIALLY
 *               RECOMMENDED model — Cohere's bare "command-r"
 *               alias is what was deprecated/shut down
 *               (2025-09-15). Do not swap this for "command-r"
 *               or "command-r-latest" (no such alias exists);
 *               that would break it, not fix it.
 ...
 *               The "vendor/" prefix (openai/...) IS required —
 *               GitHub's own docs show every example with it;
 *               removing it returns 404, it does not fix one.
 ...
 *               OpenAI-compatible /v1/chat/completions. (The
 *               flagship Llama-4-Maverick-17B-128E-Instruct is
 *               also a real, documented vision model on
 *               SambaNova, but it's listed as a capacity-limited
 *               preview model — 3.2-11B-Vision is the safer
 *               default for free-trial keys.)
